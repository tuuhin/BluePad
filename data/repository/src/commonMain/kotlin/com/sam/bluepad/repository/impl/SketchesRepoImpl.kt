...
import com.sam.bluepad.common.shared.IHashGenerator
...
import com.sam.bluepad.domain.repository.ISketchesRepository
import com.sam.bluepad.domain.repository.Sketches
import com.sam.bluepad.domain.utils.Resource
import com.sam.bluepad.model.sketches.CreateSketchModel
import com.sam.bluepad.model.sketches.SketchChangeType
import com.sam.bluepad.model.sketches.SketchModel
import com.sam.bluepad.repository.exceptions.InvalidSketchIdException
import com.sam.bluepad.repository.mapper.toContent
import com.sam.bluepad.repository.mapper.toContentEntity
import com.sam.bluepad.repository.mapper.toMetaDataEntity
import com.sam.bluepad.repository.mapper.toModel
...
@Factory(binds = [ISketchesRepository::class])
internal class SketchesRepoImpl(
    ...
    private val hasher: IHashGenerator,
    ...
    override suspend fun readSketches(offset: Int, count: Int): Result<List<SketchModel>> {
        return runCatching {
            sketchesDao.readAllSketchesViaOffsetLimit(offset = offset, limit = count)
